...
const Form = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        let details = {
            ...
            messgage: message.value
        };
        e.preventDefault();
        setStatus("Sending ->");
        //something is going wrong with the response - generating a statusCode 404 error 
        const res = await axios.post(process.env.REACT_APP_PORT_KEY || "http://localhost:8888/api/sendmail", details)
            .then(result => {
